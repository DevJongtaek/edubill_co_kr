...
public interface IService
{
    ...
    [OperationContract]
    DataTable GetUsers_new(Request value);
    ...
    [OperationContract]
    DataSet GetReturnOrders(Request value);

    [OperationContract]
    DataSet GetDCenterOrders(Request value, string dCenterCode);

    [OperationContract]
    DataSet GetDCenterReturnOrders(Request value, string dCenterCode);
    ...
    [OperationContract]
    DataSet GetTimeReturnOrders(Request value);

    [OperationContract]
    DataSet GetTimeDCenterReturnOrders(Request value, string dCenterCode);

    [OperationContract]
    DataSet CompanyGetTimeReturnOrders(Request value);

    [OperationContract]
    DataSet CompanyGetTimeDCenterReturnOrders(Request value, string dCenterCode);
	...
	[OperationContract]
    bool ServiceFlag_new(string userid);
}
