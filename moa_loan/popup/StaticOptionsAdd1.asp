...
<table width="360" border="0" cellspacing="1" cellpadding="0" bgcolor="#ffffff">
	...
	<tr>
		<td>
		<form name = "form" action="StaticOtionsAddOk1.asp" method=post>
			<table border="0" cellspacing="1" cellpadding="0" width=360  id="Table1">
					
				
					<tr height=28>
						
						<td bgcolor=#FFFFFF align="center" colspan="2"><font style="font-weight: bold">추가하실 소속 지사명을 입력하십시오.</font></td>
					</tr>
					<tr height=28>
			...
			<select name="searchc" size="1" class="box_work" onChange="Select_cate(this.form2,'');">
	          	<!--		<option value="0">지역</option>-->
					<%if barrayint<>"" then%>
						...
						<%next%>
					<%end if%>
        		</select>&nbsp;<input type='text' name='Name' style='width:200px;'>
						</td>
					</tr>
