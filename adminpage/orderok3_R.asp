...
<table border="0" cellspacing="1" cellpadding="1" width=100% bgcolor=#BDCBE7>
	<tr bgcolor=#F7F7FF align=center>
		<td width=8% class="auto-style1">상품코드</td>
		<td width=18% class="auto-style1">상품명</td>
		<td width=10% class="auto-style1">규격</td>
		<td width=10% class="auto-style1">단가</td>
		<td width=10% class="auto-style1">수량</td>
        <td width="10%" class="auto-style1">반품사유</td>
		<td width=14% class="auto-style1">공급가액</td>
		<td width=10% class="auto-style1">세액</td>
		<td width=10% class="auto-style1">비고</td>
	</tr>
...
%>
	...
	<tr height=28 bgcolor=#F7F7FF align=center>
		...
		<td><%if Rgubun = "1" then %>반품 <%else%> 주문 <% end if %></td>
	</tr>
	<%
