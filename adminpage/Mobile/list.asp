...
<form action="list.asp" method="POST" name=form>
	<tr>
		<td nowrap width="16%" bgcolor="#F7F7FF" height="25"> &nbsp;<B>검색</td>
	</tr>
	<tr>
		<td nowrap width="84%" bgcolor="#FFFFFF" height="25">
			...
			<input type="button" name="오늘" value="오늘" class="box_work"' onclick="javascript:serchtodaycheck(document.form.searchd, document.form.searche);"> 예)20040928
			<BR>
...
<table border="0" cellspacing="0" cellpadding="0" bordercolorlight="#999966" bordercolordark="#FFFFFF" width="100%">
	...
	<tr>
		<td width=60% align=right><font color=red>배달일자’에 ‘*’ 혹은 ‘주문확인’ 건은 수정이나 취소 못함.</font></td>
	</tr>
	<tr>
		<td align=right>(<%if imsivatflag="y" then%>부가세포함<%elseif imsivatflag="n" then%>부가세별도<%elseif imsivatflag="a" then%>비과세<%end if%>)</td>
	</tr>
</table>
