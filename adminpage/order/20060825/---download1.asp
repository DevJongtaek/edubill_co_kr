...
if imsifileflag="2" then
	...
	SQL = "SELECT A.bidxsub, C.pidx, B.idx, A.tcode, C.pcode, C.ordernum, C.flag, C.rordernum, A.fileregcode"
	...
	Do Until rs.EOF
		...
		ordernum = left(Trim(rs("ordernum")),8)
