...
<%
	...
	if imsifileflag="7" then
		...
		if cbrandchoice<>"" then
			...
			minmaxsql = minmaxsql & " AND (d.cbrandchoice='' "
			minmaxsql = minmaxsql & " or d.cbrandchoice='"& cbrandchoice &"' )"
		end if
...
elseif imsifileflag="7" then
	...
	if cbrandchoice<>"" then
		...
		sql = sql & " AND (d.cbrandchoice='' "
		sql = sql & " or d.cbrandchoice='"& cbrandchoice &"') "
	end if
