...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
	...
	SQL = sql & " 	left outer join "
	SQL = sql & " 	(select tb_company.idx,tb_company.tcode,tb_company.idxsubname, tb_company.mi_money, tb_company.ye_money, tb_company.orderflag, tb_company.comname, admin.tcode as admin_code, tb_company.soundfile from tb_company join tb_company admin on tb_company.bidxsub = admin.idx where bidxsub = "& left(session("Ausercode"),5) &") e "
