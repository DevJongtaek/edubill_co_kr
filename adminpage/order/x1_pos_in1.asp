<%
	...
	if errmsg="" then
		...
		dbstr = "provider=sqloledb;server=211.202.210.85;database=juk;uid=taidi;pwd=q123456;"	'db를 연다
		db.Open dbstr
		'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
		...
		Sql = sql & " order by OD_DATE asc ,OD_TIME asc, OD_CUST asc, ODD_ITEM asc "
		rs.Open sql, db, 1
		if not rs.eof then
