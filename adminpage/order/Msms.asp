...
<%
   ...
   tcodeA = split(tcode,",")
    ...
    nextdate = replace(FormatDateTime(DateAdd("d", 1, Now()), 2),"-","")
    nextday = mid(nextdate,5,2) +"/"+ right(nextdate,2)
    
    If left(session("Ausercode"),5) = "19209" then 

    searchf = "내일("+ nextday+ ") "+ Chr(13)&Chr(10)+"배송분 주문내역이 없습니다. "+ Chr(13)&Chr(10)+"10시까지전화주문바랍니다."+ Chr(13)&Chr(10)+"(1661-9481)"
...
<body leftmargin="0" topmargin="0">
    <form name="form" action="msmsok.asp">
...
<table border="0" cellspacing="1" cellpadding="1" width=100% >
      <tr height=70 bgcolor=#F7F7FF align=center>
		<td width=100% colspan="2">
            <textarea name="searche" maxlength="80" style="width:100%;height:70px;BORDER-RIGHT: #BDBEBD 1px solid; BORDER-TOP: #BDBEBD 1px solid; BORDER-LEFT: #BDBEBD 1px solid; BORDER-BOTTOM: #BDBEBD 1px solid" class="box_work"  onKeyup="javascript:maxLengthCheck('80', null, this, byteprint);"><%=searchf%></textarea>
     <!--  <%=tcode%>-->
		</td>
