<%
	...
	SQL = "SELECT  A.bidxsub, C.pidx, B.idx, A.tcode, C.pcode, C.rordernum, C.flag, dateadd(day,1,convert(datetime,orderday)) as deflagday, B.orderday,B.carname,A.fileregcode, D.fileregcode "
...
'response.write sql
	...
	''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
		...
		imsilinetxt1 = imsilinetxt1 & "<td>납품일자</tD>"
		'imsilinetxt1 = imsilinetxt1 & "<td>체인점코드</tD>"
		imsilinetxt1 = imsilinetxt1 & "<td>인도처코드</tD>"
