...
response.write session("Ausergubun")&"-1<BR>"
response.write session("Adcenteridx")&"-2<BR>"

	set rslist = server.CreateObject("ADODB.Recordset")
	sql = " select d.idx,d.usercode,d.comname1,d.comname2,d.orderday,d.ordermoney,d.carname,d.ordering,d.flag,d.wdate,d.rordermoney,d.deflagday,d.sendhpnum,d.FtpFile,order_cmt,d.imsiflag,e.tcode,d.orderflag,e.idxsubname "
	SQL = sql & " from ( "
	...
	'8월29일 본사미수금체크 한다-보임   안한다-안보임
	'if imsimyflag="n" then
	'	SQL = sql & " and b.rordernum > 0 "
	'end if
