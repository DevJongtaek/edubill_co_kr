...
<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#ffffff" align="center">
<FORM NAME="sms" method="post" action="send_save4.asp" ENCTYPE="MULTIPART/FORM-DATA" onsubmit="return smscheck()">
	<tr height="47">
		<td><font color=blue size=3><B>[ 브랜드일괄수정 ]</td>
	</tr>
</table>
...
<table cellspacing=1 cellpadding=1 width="100%" border=0 bgcolor=#BDCBE7>
	<tr bgcolor=#F7F7FF height=22 align=center>
		<td width=30%><font color=red>*</font><B>엑셀파일선택</td>
		<td width=70% bgcolor=white><INPUT TYPE="FILE" NAME="bfile4" size="40"> <a href="#"><input type="button" value="양식다운" onClick="self.location='excell7.asp';"></a> 
