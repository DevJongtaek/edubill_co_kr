...
<table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#ffffff" align="center">
	<tr height="47">
		<td><font color=blue size=3><B>[ 물류센터관리 ]</td>
	</tr>
</table>

<table border="0" cellspacing="1" cellpadding="1" width=100% bgcolor=#BDCBE7>
	<tr height=28 bgcolor=#F7F7FF align=center>
		<td width=30%><B>코드번호</td>
		<td width=30%><B>물류센터명</td>
		<td width=40%><B>구분</td>
	</tr>
<%
if idx<>"" then
...
<form action="dwriteok.asp" method=post name=form>
...
<form action="dwriteok.asp" method=post name=form2>
<input type=hidden name=idx value="<%=idx%>">
