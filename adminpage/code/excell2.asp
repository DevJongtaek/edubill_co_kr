...
<table border=1>
	<tr>
		...
		<td><font color=blue>체인점코드</td>
		<td><font color=blue>체인점명</td>
		<td><font color=blue>대표자</td>
		<td><font color=blue>사업자등록번호</td>
		<td><font color=blue>우편번호</td>
		<td><font color=blue>주소1</td>
		<td><font color=blue>주소2</td>
		<td><font color=blue>업태</td>
		<td><font color=blue>업종</td>
		<td><font color=blue>전화번호</td>
		<td><font color=blue>핸드폰번호</td>
		<td><font color=blue>호차</td>
		<td><font color=blue>파일생성코드</td>
