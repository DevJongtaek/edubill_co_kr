...
<%
	...
	select case idx
		case ""
			...
			if imsicount = 0 then
				SQL = "INSERT INTO tb_product(usercode,pcode,pname,pprice,ptitle,gubun,bigo,soundfile,fileregcode,wdate,wuserid,cbrandchoice,proout,qty_code,prochoice,proimage,dcenterchoice) VALUES "
