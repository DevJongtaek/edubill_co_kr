...
<%
	...
	select case idx
		case ""
			...
			if imsicount=0 then
				SQL = "INSERT INTO tb_company(tcode,flag,bidxsub,idxsub,idxsubname,comname,name,post,addr,addr2,companynum1,companynum2,companynum3,uptae,upjong,orderreg,fileflaglevel,"
				...
				SQL = SQL & " cbrandchoice,d_requestday,order_weekgubun,order_weekchoice,order_checkStime,order_checkEtime,myflag,ye_money,mi_money,agencycheck2,ch_gongi,chk_gongi1,chk_gongi2, "
				SQL = SQL & " serviceflag,dcenterflag,djflag,smsflag,myflag_select,proflag1,proflag2,miorderflag,virtual_acnt,noteflag,accountflag,misuprint,datadel,cyberNum,misubtn,"
				SQL = SQL & " rec_fax,cporg_cd,virtual_acnt_bank,fileflagchb,virtual_acnt2,virtual_acnt2_bank,ipConFlag,choiceDcenter,jsusu,email,smsflagType,proflag2Pgubun,kbnumAreg,conSeeflag,adminProgram,myflagauth) VALUES "
				SQL = SQL & " ('"& tcode &"',"
				SQL = SQL & " '"& flag &"',"
				SQL = SQL & " "& bidxsub &","
				SQL = SQL & " "& idxsub &","
