...
<table cellspacing=1 cellpadding=1 width=800 border=0 bgcolor=#BDCBE7>
...
<%if mi_money >= 0 then%>
	&nbsp;&nbsp;&nbsp; * 현재미수금액 : \<%=mid(FormatCurrency(mi_money),2)%> 원<BR>
<%else%>
	&nbsp;&nbsp;&nbsp; * 현재미수금액 : \-<%=mid(FormatCurrency(mi_money),3)%> 원<BR>
<%end if%>
...
<table width=800  border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
			...
			<%if conSeeflag="y" then%><input type="image" src="/images/admin/l_bu01.gif" border=0><%end if%>
