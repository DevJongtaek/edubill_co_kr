...
<table border="0" cellspacing="0" cellpadding="0" bordercolorlight="#999966" bordercolordark="#FFFFFF" width="100%">
	<tr height=30 valign=bottom>
		...
		<td width=60% align=right><font color=red>배달일자’에 ‘*’ 혹은 ‘주문확인’ 건은 수정이나 취소 못함.</font> &nbsp; (<%if imsivatflag="y" then%>.<%elseif imsivatflag="n" then%>.<%elseif imsivatflag="a" then%>.<%end if%>)</td>
	</tr>
</table>
