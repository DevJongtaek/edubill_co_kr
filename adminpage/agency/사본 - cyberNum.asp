...
<table border="0" cellspacing="1" cellpadding="1" width=100% bgcolor=#BDCBE7>
	<tr height=28 bgcolor=#F7F7FF align=center>
		...
		<td width=8%>입금액</td>
		<td width=10%>여신금</td>
		<% If left(session("AAusercode"),5) <> "11934" And  left(session("AAusercode"),5) <> "19209" Then %> <td width=10%>미수금</td> <td width=6%>주문</td> <% End If  %>
	</tr>
...
%>
	...
	<tr height=22 bgcolor=#FFFFFF align=center align=center onMouseOver="this.style.background='#F7F7FF'" onMouseOut="this.style.background='#FFFFFF'">
		...
		<td><%=dep_amt%></td>
		<td><%=ye_money%></td>
		<% If left(session("AAusercode"),5) <> "11934" and  left(session("AAusercode"),5) <> "19209" Then %>		<td><%=mi_money%></td>
