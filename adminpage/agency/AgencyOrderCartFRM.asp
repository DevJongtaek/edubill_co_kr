...
<input type=hidden name="rowcount" value="<%=rowcount%>">
	<tr> 
		<td height=30 align=center class="auto-style1">
			...
			<a href="AgencyOrderFRM.asp?popnot=1&searcha=<%=searcha%>&searchb=<%=searchb%>"><img src="/images/admin/l_bu77.gif" border=0></a>
		</td>
	</tr>
