...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" valign=top>
	<tr height="20">
		<td><font color=red>※.주문방법 : ①메뉴선택▶ ②주문수량입력▶ ③장바구니담기▶ ④장바구니보기▶ ⑤등록(수정)▶ ⑥주문하기▶ ⑦완료메시지(끝)</td>
	</tr>
</table>
...
<form name=afrm method=post action=AgencyOrderFRM.asp>
	...
	<tr height="20">
		<td>
			<%if proFlagArrayInt<>"" then%>
				...
				<%next%>
				&nbsp;|&nbsp;<a href="AgencyOrderFRM.asp?popnot=1&searcha=0&searchb=<%=searchb%>"><font size=2><%if searcha="0" then%><B><%else%><font color=red><%end if%><b>전체보기</b></a>
			<%end if%>
		</td>
	</tr>
</table>
...
<form action="AgencyOrderCartOk.asp" name=form method=post>
<input type=hidden name=searcha value="<%=searcha%>">
...
<input type=hidden name=searche value="">
	...
	<tr align="left">
		...
		<tr>
			<td width=10></td><td height=23 width=5><font color=red>※</font></td><td width=10><img src="textbox.gif" ></td><td><font color=red>: 금일 주문 상품코드가 아니므로 주문을 하실 수 없습니다.</font></td><td></td>
		</tr>
		</table>
	</tr>
	<% End If %>
...
<table align=center width=770>
	<tr> 
		<td height=30 align=center>
			...
			<a href="AgencyOrderFRM.asp?searcha=<%=searcha%>&searchb=<%=searchb%>"><img src="/images/admin/l_bu02.gif" border=0></a>
		</td>
	</tr>
