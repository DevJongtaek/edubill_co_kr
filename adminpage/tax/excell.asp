...
'Server.ScriptTimeOut = 1000000
	...
	set rs = server.CreateObject("ADODB.Recordset")
	SQL = " select a.carname, a.usercode, isnull(a.sumrordermoney,0),b.idx, b.tcode,b.comname, isnull(c.imsiordermoney1,0) as imsiordermoney1,isnull(d.imsiordermoney2,0) as imsiordermoney2, b.jisacode, b.jisaname "
	SQL = sql & " from  "
...
<table border=1>
	<tr>
		<td colspan=9 align="center"><b><font size=4>지사/체인점 기간별 매출현황</font></b></td>
	</tr>
	<tr height="20">
		<td colspan=9 ><%=searchdate%></td>
	</tr>
