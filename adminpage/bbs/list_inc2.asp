...
<%end if%>
<a href="content.asp?idx=<%=rs("idx")%>&uid=<%=uid%>&gotopage=<%=gotopage%>&searcha=<%=searcha%>&searchb=<%=searchb%>"><%=txtbold%><%=rs("title")%></a>
...
%>
	...
	<tr>
        ...
        <tr>
        	<td height="30" align="center"><a href="write.asp?uid=<%=uid%>"><img src="/images/cus/bt_write.gif" width="86" height="22" border="0"></a></td>
        </tr>
</table>
