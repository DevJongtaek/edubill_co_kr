...
<script type="text/javascript" src="layout/js/layout.list.js"></script>
<%
		...
		<div id="content">
			<div id="subHead">
				...
				<div class="right_area">
					<span class="button medium icon"><span class="add"></span><button id="btn_layout_add" type="button"><%=objXmlLang("btn_layout_add")%></button></span>
				</div>
			</div>
			...
			<input type="hidden" id="intPage" value="<%=intPage%>">
				...
				<colgroup>
					<col width="1" /><col width="22" /><col width="45" /><col /><col width="80" /><col width="100" /><col width="50" />
				</colgroup>
					<thead>
						<tr>
							<th class="lineL"></th>
...
<%
	SET RS = DBCON.EXECUTE("[ARTY30_SP_LAYOUT_LIST] 'L', '" & intPage & "', '" & intPageSize & "' ")
...
%>
						<tr>
							<td class="detail"></td>
							<td class="chk"><input name="strLayoutCode" type="checkbox" id="strLayoutCode" value="<%=RS("strLayoutCode")%>"></td>
							...
							<td class="detail"><span class="button small"><a href="#" name="btn_modify" id="<%=RS("strLayoutCode")%>"><%=objXmlLang("btn_modify")%></a></span></td>
						</tr>
<%
	RS.MOVENEXT
	WEND
