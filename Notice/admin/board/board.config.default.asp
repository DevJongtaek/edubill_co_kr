...
<%
	...
	DIM strBoardID, strTitle, strLayoutCode, strCateCode, strSkinName, strSkinColor, strSkinLang, strBrowserTitle
	DIM bitUseConsult, bitUseSecret, bitUseTrash, strHeaderHtml, strFooterHtml
	...
	bitUseConsult     = GetBitTypeNumberChg(RS("bitUseConsult"))
	bitUseSecret      = GetBitTypeNumberChg(RS("bitUseSecret"))
...
<script type="text/javascript" src="board/js/board.config.default.js"></script>
		<div id="content">
			<form id="theForm">
			<input type="hidden" name="intSrl" id="intSrl" value="<%=intSrl%>">
			<div id="subHead">
				<h3><%=objXmlLang("page_title_config_default")%></h3>
			</div>
			<p class="subHeadDesc">
			<%=objXmlLang("page_description_config_default")%>
			</p>
			<div id="subBody">
<!-- #include file = "board.config.comm.asp" -->
				...
				<table class="tabletype01">
					<tr>
						...
						<td>
						<input name="strBoardID" type="text" id="strBoardID" value="<%=strBoardID%>" size="30" maxlength="30"/>
					...
					<tr>
						...
						<td>
						<input name="strTitle" type="text" id="strTitle" value="<%=strTitle%>" size="80" maxlength="100"/>
...
%>
					...
					<tr>
						...
						<td>
							<input name="strBrowserTitle" type="text" id="strBrowserTitle" value="<%=strBrowserTitle%>" size="100" maxlength="200"/>
					...
					<tr>
						<th scope="row"><%=objXmlLang("title_use_trash")%></th>
						<td>
							<dl class="radio_form">
								<%=GetMakeRadioForm(objXmlLang("option_use"), ",", bitUseTrash, "bitUseTrash", "<dd>", "</dd>")%>
							</dl>
							<p class="tip"><%=objXmlLang("about_use_trash")%></p>
						</td>
					</tr>
					<tr>
						<th scope="row"><%=objXmlLang("title_header_html")%></th>
						<td>
							<textarea name="strHeaderHtml" id="strHeaderHtml" class="resizable"><%=strHeaderHtml%></textarea>
					...
					<tr>
						...
						<td>
							<textarea name="strFooterHtml" id="strFooterHtml" class="resizable"><%=strFooterHtml%></textarea>
