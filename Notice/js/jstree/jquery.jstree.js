...
(function ($) {
	...
	$(function () {
		var css_string = '' + 
			'#vakata-contextmenu { display:none; position:absolute; margin:0; padding:0; min-width:130px; background:#ebebeb; border:1px solid silver; z-index:10000; *width:130px; } ' + 
			'#vakata-contextmenu ul { min-width:120px; *width:130px; } ' + 
