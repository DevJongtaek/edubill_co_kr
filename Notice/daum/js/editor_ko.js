...
var TrexConfig = function() {
	...
	var __ICON_IMAGES_PATH = "../../images/icon/ko/";
...
//포커스			this.getProcessor().focusOnTop();
		},
		/**
...
TrexConfig.addAttacher(
	...
	{	
		...
		wysiwygonly: true,
		objattr: {},
		features: { left:250, top:65, width:637, height:521 },
//		features: { left:250, top:65, width:450, height:404 },

		popPageUrl: "#host#path/pages/popup/ko/image.html"
	},
	function(root){
...
TrexConfig.addAttacher(
	"file",
	{
		...
		wysiwygonly: false,
		features: { left:250, top:65, width:450, height:404 },
		popPageUrl: "#host#path/pages/popup/ko/file.html"
//		popPageUrl: "#host#path/pages/popup/ko/file_old.html"
...
TrexConfig.addEmbeder(
	"media",
	{
		...
		popPageUrl: "#host#path/pages/popup/ko/multimedia.html"
	},
	function(root) {
