<!-- #include file = "../../../Include/Account.Pwd.Form.asp" -->
<!-- #include file = "common.header.asp" -->
<script type="text/javascript" src="<%=CONF_skinPath%>js/account.pwd.form.js"></script>
<form id="theForm" method="post">
<div id="bodyWrap" class="accountpwd_form">
	<div class="page_navi">
	...
	<div class="box01">
		<fieldset>
			<dl class="fields">
				<ul>
					<li>
						<dt class="account"><%=objXmlLang("user_id")%></dt>
						<dd><input type="text" id="userid" name="userid" class="input_text userid" /></dd>
					</li>
					<li>
						<dt class="account"><%=objXmlLang("user_name")%></dt>
						<dd><input type="text" id="username" name="username" class="input_text name" /></dd>
					</li>
					<li>
...
<% END IF %>
			...
			<ul class="field_desc">
				<li class="list"><%=objXmlLang("about_find_password")%></li>
			</ul>
		</fieldset>
	</div>
	<div class="btn_area">
		<span class="button large strong"><input type="submit" value="<%=objXmlLang("cmd_find_password")%>" /></span>
		<span class="button large strong"><a href="?act=member&subAct=findid"><%=objXmlLang("cmd_find_id")%></a></span>
	</div>
</div>
</form>
