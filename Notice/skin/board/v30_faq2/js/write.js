	...
	$(document).ready(function() {
		...
		$("#btn_fontsize").bind({
			click: function() {
				$("#tx_titleFontSize_menu").toggle();
			},
			mouseover: function() {
				$(this).addClass("font_size_on");
			},
			mouseout: function() {
				$(this).removeClass("font_size_on");
			}
		});

		$("#tx_titleFontSize_menu a").click(function() {
			$("#btn_fontsize span").text($(this).attr("id"));
		...
		$("#btn_fontbold").bind({
			...
			mouseover: function() {
				if ($("#writeForm #bitTitleBold").val() == ""){
					$(this).addClass("font_bold_on");
				}
			},
			mouseout: function() {
				if ($("#writeForm #bitTitleBold").val() == ""){
					$(this).removeClass("font_bold_on");
				}
			}
		});
		...
		var j = 0; var c_html = "";
		for (var i = 0; i < set_color.options.length; i++) {
			j++;
			if (j == "1")
				c_html +="<ul>\n";
	
			c_html +="<li style=\"float:left; background-color:" + set_color.options[i].color + "; border:1px solid " + set_color.options[i].border + ";\"></li>\n";
			if (j == "10"){
				c_html +="</ul>\n";
				j = 0;
			}
		...
		$("#tx_titleFontColor_menu").html(c_html);

		$("#tx_titleFontColor_menu li").click(function(){
			$("#writeForm #strTitleColor").val($(this).css("background-color"));
			$("#theForm #title").css("color",$(this).css("background-color"));
			$("#title_font_color").css("background-color",$(this).css("background-color"));
			$("#tx_titleFontColor_menu").toggle();
		});
		...
		$("#btn_fontcolor").bind({
			...
			mouseover: function() {
				$(this).addClass("font_color_on");
			},
			mouseout: function() {
				$(this).removeClass("font_color_on");
			}
		...
		$("#btn_fontreset").bind({
			...
			mouseover: function() {
				$(this).addClass("font_reset_on");
			},
			mouseout: function() {
				$(this).removeClass("font_reset_on");
			}
		...
		$("#theForm").submit(function() {
			...
			$("#writeForm #bitAllowComment").val("0");
			$("#writeForm #bitAllowScrap").val("0");
