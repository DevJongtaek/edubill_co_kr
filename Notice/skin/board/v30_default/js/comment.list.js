					...
					if (responseText.length > 0){
						for(var i = 0; i < responseText.length; i++){
							if (responseText[i].downlevel == "0"){
								$("#comment_file_" + comment_id).append("<li><a href=\"#comment_file\">" + responseText[i].filename + " <span class=\"bubble\">[Size : " + responseText[i].filesize1 + " / Download : " + responseText[i].filedown + "]</span></a></li>");
							}else{
